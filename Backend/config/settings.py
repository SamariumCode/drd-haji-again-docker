...
INSTALLED_APPS = [
    ...
    'debug_toolbar',  # Django Debug Toolbar (if used)
    # Add your apps here
    "core",
    "store",
]
...
INTERNAL_IPS = ['127.0.0.1', '172.18.0.1']  # Add the Docker internal IP if different
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.getenv('REDIS_URL', 'redis://redis:6379/1'),  # Default Redis URL
        'OPTIONS': {
